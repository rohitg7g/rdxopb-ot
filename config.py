...
# ------------------------------------------------
API_ID = int(os.environ.get("API_ID", "37166634"))

# ------------------------------------------------
API_HASH = os.environ.get("API_HASH","36ffee547af7f9eca0a24be19aa7ad30")

# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8572462015:AAG9_789XylVnNyY0uA_TzdMbkntfphO8nE")

# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@rdxoaura_ bot")
BOT_TEXT = "Mtaiirus KA EXTRACTOR"
# ------------------------------------------------
OWNER_ID = int(os.environ.get("OWNER_ID", "37166634"))
# ------------------------------------------------
# //LOG CHANNEL ID 
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002282707653"))

# //FORCE_CHANNEL_ID
CHANNEL_ID2 = int(os.environ.get("CHANNEL_ID2", "-1002282707653")) 
# ------------------------------------------------
